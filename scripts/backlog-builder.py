...
# 각 유형의 Notion 템플릿이 제공하는 placeholder 헤더와 동일한 이름을 사용한다.
# template_id로 생성한 페이지에서 `update_content`로 in-place 치환할 때 이 이름이 그대로 들어가야 한다.
CONTENT_TEMPLATES = {
    "Initiative": [
        "### 비즈니스 목표 및 비전\nKPI/OKR 기반 목표, 정량 지표, 기간\n\n",
        "### 이니셔티브 세부 설명\n왜 지금, 배경, 핵심 가설\n\n",
        "### 예상 에픽\n하위 Epic 목록\n\n",
    ],
    "Epic": [
    ...
    "Bug": [
        "### 발생 환경\n기기, OS, 브라우저, 발생 위치, 계정 유형 (toggle 보존)\n\n",
        "### 실제 동작\n1. \n2. \n3. \n\n",
        "### 완료 기준\n기대되는 정상 동작\n\n",
        "### 기타 의견\n빈도, 스크린샷, 관련 로그\n\n",
    ],
