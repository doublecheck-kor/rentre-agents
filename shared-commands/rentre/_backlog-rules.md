...
|----------|-------------------|----------|
| /rentre:agile | Epic, Story, Task | 10라운드 토론 결과 기반, 전체 규칙 적용 |
| /rentre:develop | Task, Sub-Task, Bug | 개발 완료 후 상태 업데이트 포함 |
| /rentre:quickdev | Task, Sub-Task | 최소 필수 필드 준수, 간결하게 |
| /rentre:brainstorm | Discovery, Epic | 질문형 제목, 가설 기반 |
| /rentre:party | 다양 | "백로그로" 명령 시 이 규칙 참조 |
